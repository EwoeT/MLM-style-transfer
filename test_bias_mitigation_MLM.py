...
parser.add_argument("-mitigation_model_path", required=True)
parser.add_argument("-generate_neutral_latent_embedding_model_path", required=True)
parser.add_argument("-bias_class_discriminator_path", required=True)
