...
parser.add_argument("-val_dataset_path", default="binary_bias_classification_val_dataset.pt")
...
from straight_through_modeling_bert import BertForSequenceClassification
